...
VALUES
  (1001, 'Alice Admin',  'alice@example.com',  '$2a$10$admin',  'alice',  '100-0001', 1, 1, '女', 'active', NOW()),
  (1002, 'Bob Manager',  'bob@example.com',    '$2a$10$manager','bob',    '100-0002', 1, 2, '男', 'active', NOW()),
  (1003, 'Carol Member', 'carol@example.com',  '$2a$10$member', 'carol',  '100-0003', 2, 3, '女', 'active', NOW())
